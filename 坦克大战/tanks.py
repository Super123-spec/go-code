...
class enemyTank(pygame.sprite.Sprite):
	def __init__(self, x=None, kind=None, is_red=None):
		...
		if kind is None:
			...
			self.kind = kind
		# 所有坦克
		self.tanks1 = ['./图片/enemyTank/enemy_1_0.png', './图片/enemyTank/enemy_1_1.png', './图片/enemyTank/enemy_1_2.png', './图片/enemyTank/enemy_1_3.png']
		self.tanks2 = ['./图片/enemyTank/enemy_2_0.png', './图片/enemyTank/enemy_2_1.png', './图片/enemyTank/enemy_2_2.png', './图片/enemyTank/enemy_2_3.png']
		self.tanks3 = ['./图片/enemyTank/enemy_3_0.png', './图片/enemyTank/enemy_3_1.png', './图片/enemyTank/enemy_3_2.png', './图片/enemyTank/enemy_3_3.png']
		self.tanks4 = ['./图片/enemyTank/enemy_4_0.png', './图片/enemyTank/enemy_4_1.png', './图片/enemyTank/enemy_4_2.png', './图片/enemyTank/enemy_4_3.png']
