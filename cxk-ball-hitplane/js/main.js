...
// 定义移动函数
function moveLeft() {
    var currentLeft = parseInt(selfplan.imagenode.style.left);
    if (currentLeft > 0) {
        selfplan.imagenode.style.left = (currentLeft - 30) + 'px'; // 移动10像素
    }
}

function moveRight() {
    var currentLeft = parseInt(selfplan.imagenode.style.left);
    var maxLeft = window.innerWidth - selfplan.plansizeX;
